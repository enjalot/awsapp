...
from motoproto.users.models import MotorUser
from django.contrib.auth.models import User

#form for editing tegaki users
class MotorUserForm(forms.ModelForm):
    class Meta:
        model = MotorUser
        exclude = ('user',)

    def __init__(self, *args, **kwargs):
        super(MotorUserForm, self).__init__(*args, **kwargs)
...
class SelfMUForm(MotorUserForm):
    class Meta(MotorUserForm.Meta):
        exclude = ('user',)
