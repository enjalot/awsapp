...
var Roar = new Class({
	...
	inject: function(elements, options) {
		...
		//Add a border
		this.items.push(item.addEvent('mouseenter',function(){this.getFirst().addClass('roarBorder')}));
		//Remove the border
		this.items.push(item.addEvent('mouseleave',function(){this.getFirst().removeClass('roarBorder')}));
